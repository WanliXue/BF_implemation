...
# bf_train = bf_ts.only_store_neibour(testdata)
# # print(type(bf_train))
...
for i in range(1):
    ...
    bf_train = bf_ts.only_store_neibour(chan)  # the result it a list and hard to convert to np array
    print(len(bf_train[0]))

    filename = '/Users/wanli/Desktop/bf_deep/saved_only_neighbours/bfed_batch'+str(batch)+'_'+ str(i) + '_dis003.npy'
