...
filename = '/Users/wanli/Desktop/tmp/aruna/raw_cifar_preprocess/preprocess_test.npy'
...
for i in range(3):
    ...
    filename = '/Users/wanli/Desktop/bf_deep/saved_cifar_data/bfed_batch_test'+str(i) + '.npy'
